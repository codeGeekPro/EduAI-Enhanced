@echo off
REM Script de build optimisé pour mobile - EduAI
REM Génère une version PWA optimisée pour appareils mobiles
...
call node validate-pwa.js

echo.
echo [6/6] Tests mobile automatisés...
call node test-mobile.js
